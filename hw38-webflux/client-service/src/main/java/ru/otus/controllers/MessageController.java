...
public class MessageController {
    ...
    private static final String HOTEL_ROOM = "1408";
    ...
    public void getMessage(@DestinationVariable String roomId, Message message) {
        ...
        if (roomId.equals(HOTEL_ROOM)) {
            throw new ChatException("Messages from 1408 room can't be saved");
        }
        ...
        template.convertAndSend(String.format("%s%s", TOPIC_TEMPLATE, HOTEL_ROOM),
                new Message(HtmlUtils.htmlEscape(message.messageStr())));
    }
