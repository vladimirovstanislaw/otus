...
public class GcDemo {
    ...
    private volatile int objectArraySize = 5_000_000;

    public static void main(String[] args) throws Exception, InterruptedException, MalformedObjectNameException {
    ...
    private static void switchOnMxBean(GcDemo gcDemo) throws MalformedObjectNameException, NotCompliantMBeanException, InstanceAlreadyExistsException, MBeanRegistrationException {
